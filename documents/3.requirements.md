...
* [ ] Set Java version (17+ recommended)
* [ ] Choose build tool: Maven or Gradle
* [ ] Configure application properties (port, DB connection, etc.)
...
* [ ] Create initial schema (can use provided SQL)

Example Docker command:
```bash
docker run --name finance-db -e POSTGRES_DB=finance -e POSTGRES_USER=finance -e POSTGRES_PASSWORD=finance -p 5432:5432 -d postgres:16
```

### Tools
* [ ] Install Java 17+ (JDK)
* [ ] Install Maven or Gradle
* [ ] Install Docker (for DB)
